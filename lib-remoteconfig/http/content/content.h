...
#if defined(NODE_ARTNET) || defined(NODE_ARTNET_MULTI)
	{ 2110753961,"config_artnet.js", config_artnet_js_gz, 1027, static_cast<http::ContentTypes>(2), true },
#endif // defined(NODE_ARTNET) || defined(NODE_ARTNET_MULTI)
	{ 2226674728,"layout.js", layout_js_gz, 553, static_cast<http::ContentTypes>(2), true },
...
#if defined (NODE_LTC_SMPTE)
	{ 109007079,"config_etc.js", config_etc_js_gz, 656, static_cast<http::ContentTypes>(2), true },
#endif // (NODE_LTC_SMPTE)
#if defined (NODE_OSC_SERVER)
	{ 3728864745,"config_oscserver.js", config_oscserver_js_gz, 670, static_cast<http::ContentTypes>(2), true },
#endif // (NODE_OSC_SERVER)
	{ 2557875310,"styles.css", styles_css_gz, 701, static_cast<http::ContentTypes>(1), true },
	{ 4156522053,"status_index.js", status_index_js_gz, 273, static_cast<http::ContentTypes>(2), true },
#if defined (NODE_LTC_SMPTE)
	{ 610379173,"config_gps.js", config_gps_js_gz, 603, static_cast<http::ContentTypes>(2), true },
#endif // (NODE_LTC_SMPTE)
#if defined (DMXNODE_PORTS)
	{ 3906326706,"config_dmxnode.js", config_dmxnode_js_gz, 1008, static_cast<http::ContentTypes>(2), true },
#endif // (DMXNODE_PORTS)
#if !defined (CONFIG_HTTP_HTML_NO_PIXEL) && (defined(OUTPUT_DMX_PIXEL) || defined(OUTPUT_DMX_PIXEL_MULTI))
	{ 4089447436,"config_dmxpixel.js", config_dmxpixel_js_gz, 821, static_cast<http::ContentTypes>(2), true },
#endif // !defined (CONFIG_HTTP_HTML_NO_PIXEL) && (defined(OUTPUT_DMX_PIXEL) || defined(OUTPUT_DMX_PIXEL_MULTI))
	{ 247271700,"index.js", index_js_gz, 887, static_cast<http::ContentTypes>(2), true },
#if !defined (CONFIG_HTTP_HTML_NO_DMX_PCA9685) && defined(OUTPUT_DMX_PCA9685)
	{ 1666579856,"config_dmxpca9685.js", config_dmxpca9685_js_gz, 820, static_cast<http::ContentTypes>(2), true },
#endif // !defined (CONFIG_HTTP_HTML_NO_DMX_PCA9685) && defined(OUTPUT_DMX_PCA9685)
	{ 3282278349,"config_oscclient.js", config_oscclient_js_gz, 900, static_cast<http::ContentTypes>(2), true },
#if !defined (CONFIG_HTTP_HTML_NO_DMX) && defined(OUTPUT_DMX_MONITOR)
	{ 1186793998,"config_dmxmonitor.js", config_dmxmonitor_js_gz, 576, static_cast<http::ContentTypes>(2), true },
#endif // !defined (CONFIG_HTTP_HTML_NO_DMX) && defined(OUTPUT_DMX_MONITOR)
#if defined (NODE_LTC_SMPTE)
	{ 1947358610,"config_ltc.js", config_ltc_js_gz, 2285, static_cast<http::ContentTypes>(2), true },
#endif // (NODE_LTC_SMPTE)
#if defined (NODE_LTC_SMPTE)
	{ 3844231377,"config_tcnet.js", config_tcnet_js_gz, 685, static_cast<http::ContentTypes>(2), true },
#endif // (NODE_LTC_SMPTE)
#if !defined (CONFIG_HTTP_HTML_NO_RTC) && !defined (DISABLE_RTC)
...
#endif // defined(NODE_E131) || defined(NODE_E131_MULTI) || (ARTNET_VERSION == 4)
#if defined (NODE_LTC_SMPTE)
	{ 1194496967,"config_ltcdisplays.js", config_ltcdisplays_js_gz, 616, static_cast<http::ContentTypes>(2), true },
#endif // (NODE_LTC_SMPTE)
#if !defined (CONFIG_HTTP_HTML_NO_RDM) && (defined (RDM_CONTROLLER) || defined (RDM_RESPONDER))
	{ 1557939568,"config_rdmdevice.js", config_rdmdevice_js_gz, 444, static_cast<http::ContentTypes>(2), true },
#endif // !defined (CONFIG_HTTP_HTML_NO_RDM) && (defined (RDM_CONTROLLER || defined (RDM_RESPONDER))
#if defined (NODE_SHOWFILE)
	{ 1821390800,"config_showfile.js", config_showfile_js_gz, 594, static_cast<http::ContentTypes>(2), true },
#endif // (NODE_SHOWFILE)
#if !defined (CONFIG_HTTP_HTML_NO_DMX) && (defined(OUTPUT_DMX_SEND) || defined(OUTPUT_DMX_SEND_MULTI))
	{ 381868932,"config_dmxsend.js", config_dmxsend_js_gz, 760, static_cast<http::ContentTypes>(2), true },
#endif // !defined (CONFIG_HTTP_HTML_NO_DMX) && (defined(OUTPUT_DMX_SEND) || defined(OUTPUT_DMX_SEND_MULTI))
#if !defined (CONFIG_HTTP_HTML_NO_PIXEL) && (defined(OUTPUT_DMX_PIXEL) || defined(OUTPUT_DMX_PIXEL_MULTI))
